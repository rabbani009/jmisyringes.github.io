...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">JMI Blood Lancet</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Blood_Lancet/JMI-Blood-Lancet.png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Needle Size: 30G</li>
                            <li>Sterile Lancet</li>
                            <li>Tri-bevel tip for least pain sampling</li>
                            <li>Consistent depth penetration</li>
                            <li>Universal design & easy to grip</li>
                        </ul>
