...
<article class="post ttm-blog-classic clearfix">
    ...
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Nelaton_Catheter/Nelaton-Catheter.png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Latex free, manufactured from medical grade PVC</li>
                            <li>Frosted surface provides softness that helps in easy insertion</li>
                            <li>Kink resistant tubing</li>
                            <li>Soft rounded tip and two lateral eyes with smooth edges facilitates efficient drainage of urine</li>
                            <li>Universal funnel shaped connector for leak free connection with urine bag</li>
                            <li>Color coded connector helps in easy identification of catheter size</li>
                            <li>Sterilized by EO gas</li>
                        </ul>
                        <p style="color: #F89C0E;">Size (FG): 6, 7, 8, 10, 12, 14, 16 & 18</p>
                    </div>
                    <!-- Div for features -->
                    <!-- <div class="features">
