...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">Scalp Vein Set</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Scalp Vein set/Attachment-29 (Scalp Vein Set).png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Color coded butterfly wing for instant identification of needle size.</li>
                            <li>Tri bevel cut hypodermic needle facilitates superior sharpness.</li>
                            <li>Connected to transparent, soft & kink resistant tube</li>
                            <li>Non-toxic</li>
                            <li>Pyrogen free</li>
                            <li>Sterilized by EO gas</li>
                        </ul>
                        <p style="color: #F89C0E;">Size: 19 G, 21 G, 22 G, 23 G, 25 G & 27 G.</p>
                    </div>
                    <!-- Div for features -->
                    <!-- <div class="features">
