                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span>JMI Disposable Wound Drain Tube</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">JMI Disposable Wound Drain Tube</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/wound_dt/Attachment-18 (Wound Drain Tube).png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Smooth surface of the round tube makes insertion and withdrawal easy while its softness causes minimum trauma when inserted or withdrawn</li>
                            <li>Connecting to reservoir creates complete efficiency for drainage</li>
                            <li>Used for various surgeries</li>
                            <li>EO Sterilized</li>
                            <li>Latex Free</li>
                            <li>Color coded connector for easy identification</li> 
                        </ul>
                    ...
                    <div class="col-lg-3 widget-area sidebar-right">
                        <aside class="widget widget-Categories with-title">
                            ...
                            <ul>
                                ...
                                <li><a href="#">JMI Disposable Wound Drain Tube</a></li>
