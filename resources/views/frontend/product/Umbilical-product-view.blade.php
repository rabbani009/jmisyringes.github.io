...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">JMI Umbilical Cord Clamp</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Umbilical_Cord_Clamp/Attachment-21 (Umbilical Cord Clamp).png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Suitable for clamping the umbilical cord of new born baby, immediately after birth</li>
                            <li>Double purpose security lock “click” to indicate the correct locking</li>
                            <li>Finger grip ensures safe and convenient handling</li>
                            <li>Provided with grooves all along the length to prevent the slipping of the umbilical cord and retain it in the same position</li>
                            <li>Manufactured from non toxic medical grade ABS resin</li>
                            <li>EO gas sterilized</li>
                        </ul>
