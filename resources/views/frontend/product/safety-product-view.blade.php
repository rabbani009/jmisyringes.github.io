...
.ttm-post-featured img {
    max-width: 20%; /* Ensure image doesn't exceed its container */
...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">Safety Box</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/safety_box/Attachment-37 (Safety Box).png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Made of anti-perforation, puncture proof and water resistance card</li>
                            <li>Ensures safe disposal of sharp and used medical wastes</li>
                        ...
                        <p style="color: #F89C0E;">Price : 90 TK Per Box</p>
                    </div>
                    <!-- Div for features -->
                    <!-- <div class="features">
