...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">U-40 (30G)</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
            <div class="ttm-post-featured">
                    <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Insulin Syringes/Attachment-25.a [Insuline Syringe U-40 (30G)].png')}}" alt="">
                    <p class="product-name">U-40</p>
                    <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Insulin Syringes/Attachment-25.c [Insuline Syringe U-100 (31G)].png')}}" alt="">
                    <p class="product-name">U-100</p>
                    <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Insulin Syringes/Attachment-25.b.png')}}" alt="">
                    <p class="product-name">U-100</p>
            </div>
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        ...
                        <ul>
                            ...
                            <li>Capacity: 1ml</li>
                            <li>Units: U-40 & U-100</li>
                            <li>Needle Gauge: 30G & 31G</li>
                        </ul>
                    </div>
                    <!-- Div for features -->
                    <div class="features">
