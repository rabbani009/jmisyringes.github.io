...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">Disposable Needles</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Disposable Needles/Attachment-28(Disposable Needle).png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Sterile hypodermic single use needle</li>
                            <li>Superior Needle sharpness</li>
                            <li>Laser beam inspected</li>
                        </ul>
                        <p style="color: #F89C0E;">Size: 18G, 19G, 20G, 21G, 22G, 23G, 24G, 25G, 26G, & 27G.</p>
                    </div>
                    <!-- Div for features -->
                    <!-- <div class="features">
