...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">JMI Oral Dispenser</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/oral_despenser/Attachment-13 (10ml Oral Dispenser).png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>100% Dose accuracy</li>
                            <li>HDPE Plunger makes it move smoother and user friendly</li>
                            <li>Leak proof</li>
                            <li>Washable and reusable</li>
                            <li>Consists of a standard tip cap</li>
                            <li>Latex free</li>
                            <li>Made of medical grade raw materials</li> 
                        </ul>
                        <p style="color: #F89C0E;"> Size: 1ml, 2ml, 5ml & 10ml</p>
                    </div>
                    <!-- Div for features -->
                    <!-- <div class="features">
