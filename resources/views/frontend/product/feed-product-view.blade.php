                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span>JMI Disposable Feeding Tube</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">JMI Disposable Feeding Tube</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/feed_tube/Attachment-16 (Feeding tube).png')}}" alt="">
        </div>
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Suitable for neonates, pediatric and adult nutritional feeding</li>
                            <li>Distal end is coned with two lateral eyes</li>
                            ...
                            <li>Manufactured from non toxic PVC, non irritant, medical grade PVC</li>
                            <li>EO Sterilized</li>
                            <li>Latex Free</li>
                            <li>Color coded connector for easy identification of sizes</li>
                            <li>Tube is marked at 20 cm, 30cm & 40 cm from the distal tip</li> 
                        </ul>
                    ...
                    <div class="col-lg-3 widget-area sidebar-right">
                        <aside class="widget widget-Categories with-title">
                            ...
                            <ul>
                                ...
                                <li><a href="#">JMI Disposable Feeding Tube</a></li>
