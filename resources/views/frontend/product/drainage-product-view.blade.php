...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">Urine Drainage Bag</a></h2>
        </header>
    </div>
       ...
       <div class="ttm-post-featured">
                <div class="spec-features-container">
                    <div class="specifications">
                        <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/urinedrainagebag/Attachment-26-Urine Drainage Bag.png')}}" alt="">              
                    </div>
                    <!-- <div class="features">
            ...
            <div class="ttm-box-desc-text">
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        <h3>Features</h3>
                        <ul>
                            <li>Latex free, leak proof, non-sticky PVC bag</li>
                            <li>Non-return valve assures no reverse flow of urine</li>
                            <li>Specially designed T-outlet facilitates easy discharge of urine</li>
                            <li>Stable under variable temperature & easy for handling</li>
                            <li>Capacity: 2000ml</li>
                        </ul>                   
                    </div>
                    <!-- Div for features -->
                    <!-- <div class="features">
