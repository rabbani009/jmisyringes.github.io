                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span>JMI Disposable Suction Catheter</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">JMI Disposable Suction Catheter</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/suction_catheter/Attachment-19 (JMI Suction Catheter).png')}}" alt="">
        </div>
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        ...
                        <ul>
                            ...
                            <li>Distal end is open with two lateral eyes</li>
                            <li>Large opening of distal tip facilitates easy and efficient removal of secretion from airway</li>
                            <li>Color coded connector ensures instant identification of catheter size</li>
                            <li>Non-toxic, Pyrogen free & Sterilized by EO gas </li>
                        </ul>
                        <p style="color: #F89C0E;">Size (FG): 4, 5, 6, 7, 8, 10, 12, 14, 16 & 18</p>
                        <p style="color: #F89C0E;">Also available with Control Valve’ in Size (FG) : 5, 6, 8, 10, 12, 14, 16 & 18</p>
                    </div>
                    <!-- Div for features -->
                    <!-- <div class="features">
                    ...
                    <div class="col-lg-3 widget-area sidebar-right">
                        <aside class="widget widget-Categories with-title">
                            ...
                            <ul>
                                ...
                                <li><a href="#">JMI Disposable Suction Catheter</a></li>
