                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span>JMI Intrauterine Contraceptive Device (Copper T 380A)</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<article class="post ttm-blog-classic clearfix">
    <div class="ttm-post-entry-header">
        <header class="entry-header">
            <h2 class="entry-title"><a href="#">JMI Intrauterine Contraceptive Device (Copper T 380A)</a></h2>
        </header>
    </div>
    <!-- post-featured-wrapper -->
    <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid" src="{{ asset('frontend/assets/images/portfolio/Copper_T/Attachment-36 (Copper-T).png')}}" alt="">
        </div>
                ...
                <div class="spec-features-container">
                    ...
                    <div class="specifications">
                        ...
                        <ul>
                            ...
                            <li>Long lasting</li>
                            <li>Durable and safe packing</li>
                        </ul>
