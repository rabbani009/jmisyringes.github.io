...
@section('title') Appointment of MD, CEO, CFO, CS And HIAC| Message @endsection
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="breadcrumb-wrapper">
                        ...
                        <span>Appointment of MD, CEO, CFO, CS And HIAC</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                            ...
                            <div class="ttm-team-member-content mt-40">
                                <div class="section-title">
                                    <div class="title-header">
                                        <h2 class="title">Appointment of MD, CEO, CFO, CS And HIAC</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ttm-team-member-single-content row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/appointment/AP_1.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                    <!-- Image 2 -->
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/appointment/AP_2.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/appointment/AP_3.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
