...
@section('title') DR| Message @endsection
            ...
            <div class="container">
                            ...
                            <div class="ttm-team-member-content mt-40">
                                <div class="section-title">
                                    <div class="title-header">
                                        <h2 class="title">Director's Report</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ttm-team-member-single-content row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/DR/page_1.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                    <!-- Image 2 -->
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/DR/page_2.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/DR/page_3.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/DR/page_4.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="featured-item featured-team-item ttm-item-view-leftimage">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('frontend/assets/investors/DR/page_5.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
